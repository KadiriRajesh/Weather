...
public class MapsFragment extends BaseFragment implements View.OnClickListener {
    ...
    private AppCompatButton bookmarklocation;
    //vars
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if (mRootView == null) {
            mRootView = (ViewGroup) inflater.inflate(R.layout.fragment_maps, null);
            initViews();
    ...
    public void initViews() {
        ...
        mSearchText = (EditText) mRootView.findViewById(R.id.input_search);
        mGps = (ImageView) mRootView.findViewById(R.id.ic_gps);
        bookmarklocation = (AppCompatButton) mRootView.findViewById(R.id.bookmarklocation);
...
*/
    ...
    public void onClick(View view) {
        //todo need to save the location into db
        savelatlngvalues();
    }
    private void init() {
